...
export const translations: Record<Language, TranslationDict> = {
  fr: {
    ...
    kioskMode: "Mode Banc (Kiosque)",
    dashboard: "Analyses & ACWR",
    sessions: "Séances & Matchs",
    players: "Effectif U17",
  ...
  ar: {
    ...
    kioskMode: "الكشك الميداني (دكة البدلاء)",
    dashboard: "التحليلات ومؤشر ACWR",
    sessions: "الحصص والمباريات",
    players: "تعداد الفريق U17",
    reports: "التقارير والتصدير",
    about: "حول التطبيق والمؤلف",
  ...
  en: {
    ...
    kioskMode: "Bench Kiosk Mode",
    dashboard: "Analytics & ACWR",
    sessions: "Sessions & Matches",
    players: "U17 Squad Roster",
